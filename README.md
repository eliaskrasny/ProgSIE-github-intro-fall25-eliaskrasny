...
- **Elias Krasny:** Data engineering, feature engineering, modeling
- **Jiei Ota:** Exploratory analysis, visualization, documentation
- **William Wright:** Classification models, evaluation metrics
- **Elias Zell:** Literature review, interpretation, reporting
